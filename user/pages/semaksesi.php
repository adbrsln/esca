                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nyahaktif</th>
                      											...
                      											<th>Jumlah Rekod MRD</th>
                      											<th>Tempoh Downtime</th>
                      											<th>Padam Rekod</th>
								     ...
								     while($row = mysql_fetch_array($result)){
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td ><?php echo $row['nyahaktif']; ?></td>
                      											...
                      											<td><?php echo $row['jum_rekodmrd']; ?></td>
                      											<td><?php echo $row['tempoh']; ?></td>
                          									<td><center>
                          										<p><a href="padamrekod.php?transaksi_id=<?=$row["id_transaksi"];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></p>
                          									</center></td>
