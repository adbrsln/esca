                                    ...
                                    <div id="collapseThree" class="panel-collapse in">
										...
										<div class="panel-body">
											...
											<div class="col-lg-6 col-md-6">     
												...
												<label>Nama Pesakit</label>  (Jika Pesakit Unknown , sila Letakkan Unknown1 - Unknown99+) <input  name ="namapesakit" class="form-control" placeholder="" value ="<?php echo $row['nama_pesakit']; ?>"></input>
												</br>
												<label>No. K/p / No. Passport</label> (Contoh : 941109085621 Atau M941109085621)<input  name ="nric" class="form-control" maxlength="14" placeholder="" value ="<?php echo $row['nric']; ?>" >
												</br>
												<label>ID Pesakit</label>(Contoh : SB12345678)<input  name ="idpesakit" class="form-control" maxlength="10" placeholder="" value ="<?php echo $row['id_pesakit']; ?>" >
												</br>
												<div class="row">
											<div class="col-lg-6 col-md-6">  
													<label>D.O.B</label> (Contoh : 12 Februari 2015)</br>
                                                     <input  name = "dob" class="form-control" placeholder="" value = "<?php echo $row['dob']; ?>">
                                                     	</div>
                                                      <div class="col-lg-6 col-md-6">  
                                                      <label>No. Resit</label> (Jika Tiada, Biarkan Kosong)
                                                    <input name = "noresit" class="form-control" value = "<?php echo $row['resit']; ?>" placeholder="" maxlength="20" style="text-transform:uppercase" >
                                                    </div> 
                                                    </br>
                                                     </div>       
                                                 </br>       
										...
										<div class="col-lg-6 col-md-6">    
												 <label>Negara</label> (Jika Warganegara , Biarkan kosong)
                                                    <select name = "national"  class="form-control"  >
                                                    	<option value="<?php echo $row['nation']; ?>"></option>
                                                        <?php require "country.php";?>
                                                    </select>
                                                    </br>

												<label>Lokasi 1</label><input  disabled class="form-control" placeholder="" value = "<?php echo $row['lokasi']; ?>">

												</br>
												<label>Lokasi 2</label> (Contoh : Greenzone)<input  name ="lokasi2" class="form-control" placeholder="" value = "<?php echo $row['lokasi2']; ?>">
												</br>
												<label>Lokasi 3</label><input  name ="lokasi3" class="form-control" placeholder="" value = "<?php echo $row['lokasi3']; ?>">
												</br>
												<label>Lokasi 4</label><input  name ="lokasi4" class="form-control" placeholder="" value = "<?php echo $row['lokasi4']; ?>">
												</br>

											</div>
										</div> 
										<label>Lain - Lain Maklumat Pendaftaran Pesakit</label><textarea name = "lain2" class="form-control ckeditor" placeholder="Alamat , no kad pengenalan, no resit, no telefon, biling group"rows="2" cols=500><?php echo $row['lain_lain']; ?></textarea>
										</br>
										<label>Consultation Notes / Nursing Notes</label> <textarea name = "nk1" class="form-control ckeditor" rows="5" cols=500><?php //echo $row['nk1']; ?></textarea>
